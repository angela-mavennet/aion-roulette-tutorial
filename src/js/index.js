...
let myContract;
let contractAddress = "0xA00729958933f4c43D9dd3248474Ac48388621b4D6b8AbC6dD459Ef34173aAcb";
let account = "Not Detected - Please download AIWA to play this game";
const NODESMITH_URL="https://api.nodesmith.io/v1/aion/testnet/jsonrpc?apiKey=1985309ba6ee4fb29d89370104fee4fb";
...
// }
  ...
  initializeContract() {
    ...
    if (!aiwaInjected) {
      ...
      web3 = new Web3(new Web3.providers.HttpProvider(NODESMITH_URL));
